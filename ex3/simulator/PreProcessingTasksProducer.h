...
public:
    PreProcessingTasksProducer(int numTasks, std::vector<string> &paths, std::vector<TravelData> &travels_data) : AbstractTasksProducer(numTasks), m_paths(paths), m_travels_data(travels_data) {}
    PreProcessingTasksProducer(PreProcessingTasksProducer && other): AbstractTasksProducer(std::move(other)), m_paths(other.m_paths), m_travels_data(other.m_travels_data) {}
